    ...
    <div className="min-h-screen bg-[#050505] pt-28">
      ...
      <section className="px-6 pb-20">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-[clamp(2.5rem,7vw,5rem)] font-black text-[#ede8e0] leading-[0.9] tracking-tight mb-10">
            HOUSE IS A STATE<br />
      ...
      {/* Concept: STATEの定義 */}
      <section className="px-6 pb-20">
        <div className="max-w-5xl mx-auto border border-white/5 p-10 md:p-14">
          <p className="text-[#c9a96e] text-[9px] tracking-[0.5em] uppercase mb-8">Core Concept</p>
          <h2 className="text-2xl md:text-3xl font-black text-[#ede8e0] mb-8">
      ...
      {/* Concept paragraph */}
      <section className="px-6 pb-20 bg-[#0d0d0d] border-y border-white/5 py-20">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <p className="text-[#c9a96e] text-[9px] tracking-[0.5em] uppercase mb-6">The Loss</p>
              <h2 className="text-2xl font-black text-[#ede8e0] mb-6 leading-tight">
      ...
      <section className="py-20 px-6 bg-[#050505]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-px">
            {purposes.map((p) => (
              <div key={p.n} className="flex gap-8 p-8 bg-[#050505] hover:bg-[#0d0d0d] transition-colors border-b border-white/5">
                <span className="text-[#3a3628] font-black text-3xl flex-shrink-0 leading-none">{p.n}</span>
                <div>
                  <h3 className="text-[#ede8e0] font-black text-lg mb-3">{p.title}</h3>
      ...
      <section className="py-20 px-6 bg-[#0d0d0d] border-y border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-3">
              {japanReasons.map((r) => (
                <div key={r} className="flex gap-3 items-start border-b border-white/5 pb-3">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-px bg-white/5">
            {brandPrinciples.map((bp) => (
              <div key={bp.rule} className="bg-[#050505] p-8 hover:bg-[#0d0d0d] transition-colors">
      ...
      <section className="py-20 px-6 bg-[#0d0d0d] border-t border-white/5 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/circle"
              className="group flex items-center justify-center gap-2 border border-[#c9a96e]/50 text-[#c9a96e] px-8 py-4 font-bold hover:bg-[#c9a96e] hover:text-[#050505] transition-all"
            >
              Enter STATE Circle <ArrowRight size={14} />
            </Link>
            <Link
              href="/roots"
              className="flex items-center justify-center border border-white/8 text-[#7a7060] px-8 py-4 hover:text-[#ede8e0] transition-all"
            >
              ROOTS を読む
            </Link>
          </div>
